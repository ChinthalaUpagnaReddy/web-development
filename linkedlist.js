let nodeCount = 1;
    ...
    function addNode(item) {
        ...
        newNode.innerHTML = '<div class="leftdata" style=" width: 60%;">'+item+'</div><div class="rightpointer" style=" width: 40%;background-color: red; height:100%; border-top-right-radius: 5px;border-bottom-right-radius: 5px;"></div>'
    ...
    function searchElement(value) {
        var linkedList1 = document.getElementById('resu');
        const linkedList = document.getElementById('linked-list');
        let currentNode = linkedList.firstElementChild;
        while (currentNode) {
            const leftDataElement = currentNode.querySelector('.leftdata');
